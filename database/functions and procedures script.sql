-- procedure that update students data
...
------------------------------------------------------------------------------------------------------------------------    
--triger to set semster automatically
...
BEGIN
    UpdateStudentGrade(
        p_StudentId => 1,  -- replace with your student ID
        p_CourseName => 'New Data Structures and Algorithms',  -- replace with your course name
        p_Grade => 'B'  -- replace with your grade
    );
END;
...
-- procedures to enroll students into new courses
...
-- create view of departmens with courses
